  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center flex-col gap-4 px-4">
        ...
        <div
          className="my-3 mx-4 flex justify-between items-center gap-4 bg-[#010A14] px-3 py-2  w-full "
          style={{ borderRadius: "5px", border: "1px solid #A8A8A8" }}
        >
...
const Form2 = () => {
  ...
  return (
    <div>
      <div className="px-10 py-10 flex justify-between items-end  text-white">
        <h1 className="text-base md:text-2xl">Other Platforms</h1>
...
const Form3 = () => {
  ...
  return (
    <div>
      <div className="px-10 py-10 flex justify-between items-end  text-white">
        <h1 className="text-base md:text-2xl">Difficulty preference</h1>
        <p className="text-sm md:text-base opacity-50">{username}</p>
      </div>
      ...
      <div className="flex justify-center my-4 gap-2">
        {difficulties.map((difficulty, index) => (
          <div onClick={() => difficulty.isSelected = true}
            className={`text-white opacity-80 rounded-lg px-5 py-2  hover:bg-[#171e41] ${difficulty.isSelected ? 'bg-[#67BBFF]' : 'bg-[#010A14]'} `}
      ...
      >
        ...
        <div className="main-form-container flex flex-col items-center">
          ...
          <div className="bg-[#BFBFBF70] h-2 flex items-center justify-center gap-2 px-3 py-4 rounded-full mt-4 mb-10">
            {forms.map((_, index) => (
              <div
                className={`bg-black w-3 h-3 cursor-pointer rounded-full ${
          ...
          {/* <div className="bg-[#BFBFBF70] h-2 flex items-center justify-center gap-2 px-3 py-4 rounded-full mt-4 mb-10">
            <div className="bg-black w-3 h-3  cursor-pointer rounded-full"></div>
            <div className="bg-black w-3 h-3  cursor-pointer rounded-full opacity-30"></div>
            <div className="bg-black w-3 h-3  cursor-pointer rounded-full opacity-30"></div>
          </div> */}
        </div>
      </div>
