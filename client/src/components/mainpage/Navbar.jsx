    ...
    return (
        <div>
            <header className="bg-black sticky top-0 z-50 flex justify-center items-center">
                <div className=" flex h-[70px] items-center justify-between gap-10 w-full lg:w-4/5 px-4 ">
                    <a href="/">
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 top-[70px] z-50 h-[calc(100vh-70px)] w-full overflow-auto md:hidden">
                    <div className=" rounded-b-lg bg-background bg-black text-foreground shadow-xl">
